...
export const endings: Ending[] = [
  ...
  careerEnding('mobile', 'rare', 4, { statWeights: { technical: 2, creativity: 2 }, minimumEvidence: { engineering: 8, productSense: 6 }, minimumActivities: { build_feature: 8, demo: 4 }, requiredSituationIds: ['mobile_launch'], activityWeights: { build_feature: 10, demo: 7, write_tests: 4 }, situationWeights: { mobile_launch: 180 }, evidenceWeights: { engineering: 10, productSense: 12, reliability: 4 } }),
