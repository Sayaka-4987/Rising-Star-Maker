...
export const endings: Ending[] = [
  ...
  careerEnding('sports_coach', 'rare', 31, { requiredTraits: ['fitness_enthusiast'], statWeights: { independence: 2, social: 2, ambition: 1 }, minimumEvidence: { fitness: 4 }, minimumActivities: { mentor_1on1: 8 }, traitBonuses: { fitness_enthusiast: 880 }, activityWeights: { mentor_1on1: 10, pair_programming: 6, team_lunch: 5 }, evidenceWeights: { fitness: 22, leadership: 9, resilience: 7 } }, 'sports_coach', 'programming_instructor'),
